        ...
        <div className="p-6">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    ...
                    className="px-4 py-2 bg-primary text-white rounded hover:opacity-90 text-sm font-medium"
                >
                    + New Meeting
                </button>
            </div>
            ...
            {meetings.length === 0 ? (
                <div className="flex flex-col justify-center items-center h-64 border-2 border-dashed border-gray-300 rounded-lg">
                    ...
                    <button
                        onClick={() => window.location.href = "/create"}
                        className="mt-4 px-4 py-2 bg-primary text-white rounded hover:opacity-90 text-sm"
                    >
                        + New Meeting
                    </button>
                </div>
